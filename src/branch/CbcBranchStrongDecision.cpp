// $Id: CbcBranchStrongDecision.cpp 2017-03-21 amk $
...
// Default Constructor
CbcBranchStrongDecision::CbcBranchStrongDecision()
        : CbcBranchDecision()
{
    bestCriterion_ = 0.0;
    bestChangeUp_ = 0.0;
    ...
    bestObject_ = NULL;
    bestNumberDown_ = 0;
//    chooseMethod_ = new OsiChooseStrong;
} /* default constructor */

// Copy constructor
CbcBranchStrongDecision::CbcBranchStrongDecision (
    const CbcBranchStrongDecision & rhs)
...
// Clone
CbcBranchDecision *
CbcBranchStrongDecision::clone() const
{
    return new CbcBranchStrongDecision(*this);
} /* clone */

// Initialize i.e. before start of choosing at a node
void
CbcBranchStrongDecision::initialize(CbcModel * model)
{
    bestCriterion_ = 0.0;
    bestChangeUp_ = 0.0;
    bestNumberUp_ = 0;
...
int
CbcBranchStrongDecision::betterBranch(CbcBranchingObject * thisOne,
...
void
CbcBranchStrongDecision::setBestCriterion(double value)
{
    bestCriterion_ = value;
} /* setBestCriterion */

double
CbcBranchStrongDecision::getBestCriterion() const
{
...
int
CbcBranchStrongDecision::bestBranch (CbcBranchingObject ** objects, int numberObjects,
                                      ...
                                      double objectiveValue)
{
  ...
  // understand in the code than numbers.
        /* Methods :
           ...
           5 - breadth-first search AMK added 2017-04-14 non-functional
        */
        ...
        /*
        case 5:
          // choose whichever one has smallest depth
          break;
        */
        }
        // set way in best
